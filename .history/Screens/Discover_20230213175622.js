        ...
        <View>
            ...
            <View>
                ...
                <View>
                    ...
                    <Image style={{height:200,width:180}} source={{uri:"https://yt3.googleusercontent.com/MRywaef1JLriHf-MUivy7-WAoVAL4sB7VHZXgmprXtmpOlN73I4wBhjjWdkZNFyJNiUP6MHm1w=s900-c-k-c0x00ffffff-no-rj"}}  />
                    <Image style={{height:200,width:180}} source={{uri:"https://image.cnbcfm.com/api/v1/image/105490644-1538754174999cnbctv_tvlistinggraphic_bluesite_v001.png?v=1538754309&w=884&h=442&vtcrop=y"}}  />
                    </View>
                    <View style={{flexDirection:'row',justifyContent:'space-evenly'}}>
                    <Image source={{uri:"https://play-lh.googleusercontent.com/0pLkIRa0-Zh64jzHsJvfj1neTRWjoGpRDLBtyRCrydUzmnjYxr9aQeRF8D-fZaHUVeI"}}  />
                    <Image source={{uri:"https://cdn.cnn.com/cnn/.e/img/3.0/global/misc/cnn-logo.png"}}  />
                    </View>
                </View>
            </View>
        </View>
