            ...
            <View>
                ...
                <View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginVertical: 5 }}>
                        <TouchableOpacity onPress={() => soucrehandle("BBC News")}>
                        ...
                        <TouchableOpacity onPress={() => soucrehandle("CNBC")}>
