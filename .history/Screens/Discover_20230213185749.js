...
const Discover = () => {
    ...
    const sources = [
        ...
        {
            "id":4,
            "img": "https://cdn.cnn.com/cnn/.e/img/3.0/global/misc/cnn-logo.png",
            "name":"CNN"
        }
    ...
    return (
        <View>
            ...
            <View>
                ...
                <FlatList showsHorizontalScrollIndicator={false} key={} data={data} horizontal={true} renderItem={({ item }) => {
                    return (
            ...
            <View>
                ...
                <View style={{flexWrap:'wrap',flexDirection:'row'}}>
                    {sources.map((item)=>{
                        return(
                            <TouchableOpacity onPress={()=>{sourcehandle(item.name)}}>
                           <Image  style={{height:200,width:190,marginHorizontal:2,marginVertical:5}} source={{uri:item.img}} />
                            </TouchableOpacity>
                        )
                    })} 
                </View>
