            ...
            {index === 0 ? (
                ...
                <View style={styles.topbarnews}>
                    ...
                    <View style={{ marginRight: 60 }}>
                        <Text style={styles.topbardiscovertitle}>My Feed</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    topbardiscovertitle: {
        fontWeight: '500', fontSize: 22, borderBottomWidth: 5, borderBottomColor: '#007FFF', borderRadius: 10
    },
    topbarnewstitle: { fontWeight: '500', fontSize: 22, borderBottomWidth: 5, borderBottomColor: '#007FFF', borderRadius: 10 }
