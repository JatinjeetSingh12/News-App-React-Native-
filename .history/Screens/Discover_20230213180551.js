            ...
            <View>
                ...
                <View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', marginVertical: 5 }}>
                        <TouchableOpacity onPress={() => sourehandle("BBC News")}>
                        ...
                        <TouchableOpacity onPress={() => sourehandle("CNBC")}>
